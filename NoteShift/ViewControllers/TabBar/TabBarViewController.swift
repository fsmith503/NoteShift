...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        CalendarVC?.title = NSLocalizedString("Calendar", comment: "TabNameForMenu")
        CalendarVC?.tabBarItem.title = NSLocalizedString("Calendar", comment: "TabNameForMenu")
        CalendarVC?.tabBarItem.selectedImage = UIImage(named: "clock")?.withRenderingMode(.alwaysOriginal)
        CalendarVC?.tabBarItem.image = UIImage(named: "clock")?.withRenderingMode(.alwaysOriginal)
